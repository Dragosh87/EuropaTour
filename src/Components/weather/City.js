                ...
                <AnimatePresence>
                    {open && (
                        ...
                        >
                            <div className="sticky top-0 z-10 bg-white">
                                <li className=" text-gray-900 cursor-default select-none relative py-2 px-3">
                                    <input
                                        ...
                                        placeholder={"Search a city in " + Country.getCountryByCode(country).name}
                            ...
                            >
                                {City.getCitiesOfCountry(country).filter((city) =>
                        ...
                        <span className="font-normal truncate">
                          {city.name}
                                                ...
                                                {selectedValue && city.name === selectedValue.name ? (<span
