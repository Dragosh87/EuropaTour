  ...
  return (
    <div  style={{ flex: '0 0 60%', backgroundColor: '#f6ebe5' }}>
      ...
      <ul className='paragraf'>
        <li>Toată lumea visează să călătorească în Europa și există un motiv pentru care.
           Fie că faci prima ta excursie solo, faci rucsacul cu un buget redus, cauti o evadare elegantă sau vrei să 
           explorezi noi orașe și culturi (nu uita de mâncare!), Europa are ceva pentru toată lumea.
        </li>
        <li>
      ...
      <ul className='paragraf2'>
        <li>
        Cu toate acestea, dacă mergi cu rucsac prin Europa, cel mai bun moment pentru a călători în regiune 
